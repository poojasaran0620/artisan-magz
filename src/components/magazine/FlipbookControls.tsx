      ...
      <div className="w-full max-w-lg mx-auto flex flex-col items-center gap-2 pt-3">
        ...
        <div className="flex items-center justify-between gap-2 px-3 sm:px-4 py-2 bg-charcoal/90 backdrop-blur-md rounded-full shadow-luxury border border-white/10 text-white w-full sm:w-auto">
          ...
          <Tooltip>
            ...
            <TooltipContent>{isAutoPlaying ? 'Pause Auto-tour' : 'Start Auto-tour'}</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>{isMuted ? 'Unmute paper sound' : 'Mute paper sound'}</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>{isFullscreen ? 'Exit Fullscreen' : 'Fullscreen View'}</TooltipContent>
          </Tooltip>
        </div>
